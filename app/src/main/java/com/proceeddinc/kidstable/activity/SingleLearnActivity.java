package com.proceeddinc.kidstable.activity;
...
import com.proceeddinc.kidstable.R;
import com.proceeddinc.kidstable.dataclasses.RandomData;
import com.proceeddinc.kidstable.modelclasses.DualModel;
import com.proceeddinc.kidstable.modelclasses.Model;
import com.proceeddinc.kidstable.utils.Constants;
import com.proceeddinc.kidstable.utils.RoundedBackgroundSpan;
...
import static com.proceeddinc.kidstable.utils.Constants.LEVEL_NO;
import static com.proceeddinc.kidstable.utils.Constants.MyPref;
import static com.proceeddinc.kidstable.utils.Constants.setDefaultLanguage;
import static com.proceeddinc.kidstable.utils.Constants.setTime;
...
public class SingleLearnActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void startSound() {
        if (Constants.getSound(getApplicationContext())) {
            ...
            mp = MediaPlayer.create(this, R.raw.eventclick);
            mp.start();
        }
    }
